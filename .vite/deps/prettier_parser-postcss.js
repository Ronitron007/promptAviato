...
var require_postcss = __commonJS({
  "node_modules/prettier/plugins/postcss.js"(exports, module) {
    (function(f) {
      ...
      var y = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), Js = (t, e) => {
        for (var s in e) bt(t, s, { get: e[s], enumerable: true });
      }, Xs = (t, e, s, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of ll(e)) !fl.call(t, n) && n !== s && bt(t, n, { get: () => e[n], enumerable: !(r = ul(e, n)) || r.enumerable });
        return t;
      };
      var ye = (t, e, s) => (s = t != null ? al(cl(t)) : {}, Xs(e || !t || !t.__esModule ? bt(s, "default", { value: t, enumerable: true }) : s, t)), pl = (t) => Xs(bt({}, "__esModule", { value: true }), t);
      var Ft = y((rv, ts) => {
        "use strict";
      ...
      var $t = y((ov, vi) => {
        "use strict";
        var wi = yi(), gi = ss(), st = class t extends Error {
          ...
          showSourceCode(e) {
            ...
            if (e) {
              let { bold: c, gray: f, red: p } = wi.createColors(true);
              a = (l) => c(p(l)), u = (l) => f(l);
            } else a = u = (c) => c;
...
`);
      ...
      var at = y((lv, ki) => {
        "use strict";
        var { isClean: Yt, my: fc } = Ft(), pc = $t(), hc = Wt(), dc = it();
        function is(t, e) {
        ...
        var ot = class {
          constructor(e = {}) {
            this.raws = {}, this[Yt] = false, this[fc] = true;
...
` ? (n = 1, i += 1) : n += 1;
      ...
      var re = y((pv, qi) => {
        "use strict";
        var { isClean: Ti, my: Oi } = Ft(), Ci = lt(), Ai = Oe(), wc = at(), Ni, os, as, Pi;
        function Ri(t) {
          return t.map((e) => (e.nodes && (e.nodes = Ri(e.nodes)), delete e.source, e));
        }
        function Ii(t) {
          if (t[Ti] = false, t.proxyOf.nodes) for (let e of t.proxyOf.nodes) Ii(e);
        }
        var Y = class t extends wc {
          ...
          normalize(e, s) {
            if (typeof e == "string") e = Ri(Ni(e).nodes);
              ...
              typeof e.value != "string" && (e.value = String(e.value)), e = [new Ci(e)];
            } else if (e.selector) e = [new os(e)];
            else if (e.name) e = [new as(e)];
            else if (e.text) e = [new Ai(e)];
            else throw new Error("Unknown node type in node creation");
            return e.map((n) => (n[Oi] || t.rebuild(n), n = n.proxyOf, n.parent && n.parent.removeChild(n), n[Ti] && Ii(n), typeof n.raws.before > "u" && s && typeof s.raws.before < "u" && (n.raws.before = s.raws.before.replace(/\S/g, "")), n.parent = this.proxyOf, n));
          }
          prepend(...e) {
            e = e.reverse();
            for (let s of e) {
        ...
        Y.default = Y;
        Y.rebuild = (t) => {
          t.type === "atrule" ? Object.setPrototypeOf(t, as.prototype) : t.type === "rule" ? Object.setPrototypeOf(t, os.prototype) : t.type === "decl" ? Object.setPrototypeOf(t, Ci.prototype) : t.type === "comment" ? Object.setPrototypeOf(t, Ai.prototype) : t.type === "root" && Object.setPrototypeOf(t, Pi.prototype), t[Oi] = true, t.nodes && t.nodes.forEach((e) => {
            Y.rebuild(e);
          });
        };
      });
      var Gt = y((hv, Di) => {
        ...
        Di.exports = function(e, s = {}) {
          let r = e.css.valueOf(), n = s.ignoreErrors, i, o, a, u, c, f, p, l, w, x, h = r.length, d = 0, m = [], b = [];
          function g() {
            return d;
          }
          function v($) {
          ...
          function F($) {
            ...
            switch (i = r.charCodeAt(d), i) {
              ...
              case 40: {
                if (l = m.length ? m.pop()[1] : "", w = r.charCodeAt(d + 1), l === "url" && w !== 39 && w !== 34 && w !== 32 && w !== 10 && w !== 9 && w !== 12 && w !== 13) {
                  o = d;
                  do {
                    if (f = false, o = r.indexOf(")", o + 1), o === -1) if (n || T) {
                      o = d;
                      break;
                    } else v("bracket");
                ...
                } else o = r.indexOf(")", d + 1), u = r.slice(d, o + 1), o === -1 || gc.test(u) ? x = ["(", "(", d] : (x = ["brackets", u, d, o], d = o);
                break;
              }
              case 39:
              case 34: {
                a = i === 39 ? "'" : '"', o = d;
                do {
                  if (f = false, o = r.indexOf(a, o + 1), o === -1) if (n || T) {
                    o = d + 1;
                    break;
                  } else v("string");
                  for (p = o; r.charCodeAt(p - 1) === 92; ) p -= 1, f = !f;
              ...
              case 64: {
                zt.lastIndex = d + 1, zt.test(r), zt.lastIndex === 0 ? o = r.length - 1 : o = zt.lastIndex - 2, x = ["at-word", r.slice(d, o + 1), d, o], d = o;
                break;
              }
              case 92: {
                for (o = d, c = true; r.charCodeAt(o + 1) === 92; ) o += 1, c = !c;
                if (i = r.charCodeAt(o + 1), c && i !== 47 && i !== 32 && i !== 10 && i !== 9 && i !== 13 && i !== 12 && (o += 1, Li.test(r.charAt(o)))) {
              ...
              default: {
                i === 47 && r.charCodeAt(d + 1) === 42 ? (o = r.indexOf("*/", d + 2) + 1, o === 0 && (n || T ? o = r.length : v("comment")), x = ["comment", r.slice(d, o + 1), d, o], d = o) : (Vt.lastIndex = d + 1, Vt.test(r), Vt.lastIndex === 0 ? o = r.length - 1 : o = Vt.lastIndex - 2, x = ["word", r.slice(d, o + 1), d, o], m.push(x), d = o);
                break;
              }
            }
            return d++, x;
      ...
      var Ae = y((mv, Wi) => {
        "use strict";
        var Ui = re(), Fi, $i, se = class extends Ui {
          constructor(e) {
...
`, "	"];
      ...
      var Ht = y((wv, Vi) => {
        "use strict";
        var zi = re(), vc = us(), Ne = class extends zi {
          constructor(e) {
      ...
      var Kt = y((gv, Hi) => {
        "use strict";
        var xc = lt(), bc = Gt(), _c = Oe(), kc = jt(), Ec = Ae(), Gi = Ht(), ji = { empty: true, space: true };
        function Sc(t) {
        ...
        var ls = class {
          constructor(e) {
            this.input = e, this.root = new Ec(), this.current = this.root, this.spaces = "", this.semicolon = false, this.createTokenizer(), this.root.source = { input: e, start: { column: 1, line: 1, offset: 0 } };
          }
          atrule(e) {
            let s = new kc();
          ...
          decl(e, s) {
            ...
            this.init(r, e[0][2]);
            let n = e[e.length - 1];
            for (n[0] === ";" && (this.semicolon = true, e.pop()), r.source.end = this.getPosition(n[3] || n[2] || Sc(e)), r.source.end.offset++; e[0][0] !== "word"; ) e.length === 1 && this.unknownWord(e), r.raws.before += e.shift()[1];
      ...
      var Re = y((Ev, ro) => {
        "use strict";
        var { SourceMapConsumer: Ac, SourceMapGenerator: Nc } = Ki(), { fileURLToPath: Zi, pathToFileURL: Qt } = {}, { isAbsolute: hs, resolve: ds } = {}, { nanoid: Pc } = Ji(), fs = ss(), eo = $t(), Rc = cs(), ps = Symbol("fromOffsetCache"), Ic = !!(Ac && Nc), to = !!(ds && hs), Pe = class {
          constructor(e, s = {}) {
            if (e === null || typeof e > "u" || typeof e == "object" && !e.toString) throw new Error(`PostCSS received ${e} instead of CSS string`);
            if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, s.from && (!to || /^\w+:\/\//.test(s.from) || hs(s.from) ? this.file = s.from : this.file = ds(s.from)), to && Ic) {
          ...
          error(e, s, r, n = {}) {
            ...
            return u ? i = new eo(e, u.endLine === void 0 ? u.line : { column: u.column, line: u.line }, u.endLine === void 0 ? u.column : { column: u.endColumn, line: u.endLine }, u.source, u.file, n.plugin) : i = new eo(e, o === void 0 ? s : { column: r, line: s }, o === void 0 ? r : { column: a, line: o }, this.css, this.file, n.plugin), i.input = { column: r, endColumn: a, endLine: o, line: s, source: this.css }, this.file && (Qt && (i.input.url = Qt(this.file).toString()), i.input.file = this.file), i;
          }
          fromOffset(e) {
            let s, r;
...
`);
          ...
          origin(e, s, r, n) {
            ...
            let u;
            hs(o.source) ? u = Qt(o.source) : u = new URL(o.source, this.map.consumer().sourceRoot || Qt(this.map.mapFile));
            let c = { column: o.column, endColumn: a && a.column, endLine: a && a.line, line: o.line, url: u.toString() };
            if (u.protocol === "file:") if (Zi) c.file = Zi(u);
      ...
      var pt = y((Sv, so) => {
        "use strict";
        var qc = re(), Lc = Kt(), Dc = Re();
        function Jt(t, e) {
          let s = new Dc(t, e), r = new Lc(s);
          try {
            r.parse();
          } catch (n) {
            throw n;
...
`));
            ...
            if (e[0] === "comment" && /^\/\*/.test(e[1])) return e[0] = "word", e[1] = e[1].slice(1), t[1] = "//", this.tokenizer.back(e), ms.exports.isInlineComment.bind(this)(t);
          }
          return false;
        } };
      });
      var oo = y((Ov, io) => {
        io.exports = { interpolation(t) {
      ...
      var uo = y((Cv, ao) => {
        var Uc = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/, Fc = /\.[0-9]/, $c = (t) => {
          let [, e] = t, [s] = e;
          return (s === "." || s === "#") && Uc.test(e) === false && Fc.test(e) === false;
        };
      ...
      var go = y((Rv, wo) => {
        var zc = Oe(), Vc = Kt(), { isInlineComment: Gc } = no(), { interpolation: yo } = oo(), { isMixinToken: jc } = uo(), Hc = co(), Kc = mo(), Qc = /(!\s*important)$/i;
        wo.exports = class extends Vc {
          constructor(...e) {
            super(...e), this.lastNode = null;
          }
          atrule(e) {
            yo.bind(this)(e) || (super.atrule(e), Hc(this.lastNode), Kc(this.lastNode));
          }
          decl(...e) {
          ...
          mixin(e) {
            ...
            if ((n < 0 || n > 3) && i > 0) {
              let c = e.reduce((g, v, R) => v[0] === ")" ? R : g), p = e.slice(i, c + i).map((g) => g[1]).join(""), [l] = e.slice(i), w = [l[2], l[3]], [x] = e.slice(c, c + 1), h = [x[2], x[3]], d = ["brackets", p].concat(w, h), m = e.slice(0, i), b = e.slice(c + 1);
              e = m, e.push(d), e = e.concat(b);
            }
            let a = [];
            for (let c of e) if ((c[1] === "!" || a.length) && a.push(c), c[1] === "important") break;
            if (a.length) {
              let [c] = a, f = e.indexOf(c), p = a[a.length - 1], l = [c[2], c[3]], w = [p[4], p[5]], h = ["word", a.map((d) => d[1]).join("")].concat(l, w);
          ...
          rule(e) {
            ...
            if (r[0] === "at-word" && s[0] === "{" && (this.tokenizer.back(s), yo.bind(this)(r))) {
      ...
      var bo = y((Lv, ys) => {
        ...
        ys.exports = { parse(t, e) {
          ...
          let e = "";
          return ys.exports.stringify(t, (s) => {
            e += s;
          }), e;
        } };
      });
      ...
      var Xt = y((Bv, So) => {
        "use strict";
        var tf = re(), ko, Eo, pe = class extends tf {
          constructor(e) {
      ...
      var _s = y((Yv, Io) => {
        "use strict";
        var { isClean: j, my: sf } = Ft(), nf = ws(), of = it(), af = re(), uf = Xt(), Wv = gs(), No = Zt(), lf = pt(), cf = Ae(), ff = { atrule: "AtRule", comment: "Comment", decl: "Declaration", document: "Document", root: "Root", rule: "Rule" }, pf = { AtRule: true, AtRuleExit: true, Comment: true, CommentExit: true, Declaration: true, DeclarationExit: true, Document: true, DocumentExit: true, Once: true, OnceExit: true, postcssPlugin: true, prepare: true, Root: true, RootExit: true, Rule: true, RuleExit: true }, hf = { Once: true, postcssPlugin: true, prepare: true }, Ie = 0;
        function mt(t) {
          return typeof t == "object" && typeof t.then == "function";
        }
        function Ro(t) {
          let e = false, s = ff[t.type];
        ...
        function Po(t) {
          let e;
          return t.type === "document" ? e = ["Document", Ie, "DocumentExit"] : t.type === "root" ? e = ["Root", Ie, "RootExit"] : e = Ro(t), { eventIndex: 0, events: e, iterator: 0, node: t, visitorIndex: 0, visitors: [] };
        }
        function xs(t) {
          return t[j] = false, t.nodes && t.nodes.forEach((e) => xs(e)), t;
        }
        var bs = {}, ne = class t {
          constructor(e, s, r) {
            this.stringified = false, this.processed = false;
            let n;
            if (typeof s == "object" && s !== null && (s.type === "root" || s.type === "document")) n = xs(s);
            else if (s instanceof t || s instanceof No) n = xs(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = false), r.map.prev = s.map);
            else {
              let i = lf;
            ...
            this.result = new No(e, n, r), this.helpers = { ...bs, postcss: bs, result: this.result }, this.plugins = this.processor.plugins.map((i) => typeof i == "object" && i.prepare ? { ...i, ...i.prepare(this.result) } : i);
          }
          async() {
      ...
      var Lo = y((Vv, qo) => {
        "use strict";
        var df = ws(), mf = it(), zv = gs(), yf = pt(), wf = Zt(), yt = class {
          constructor(e, s, r) {
      ...
      var Mo = y((Gv, Do) => {
        "use strict";
        var gf = Lo(), vf = _s(), xf = Xt(), bf = Ae(), he = class {
          constructor(e = []) {
      ...
      var Uo = y((jv, Bo) => {
        "use strict";
        var _f = lt(), kf = cs(), Ef = Oe(), Sf = jt(), Tf = Re(), Of = Ae(), Cf = Ht();
        function wt(t, e) {
      ...
      var er = y((Hv, Go) => {
        "use strict";
        var Af = $t(), Fo = lt(), Nf = _s(), Pf = re(), ks = Mo(), Rf = it(), If = Uo(), $o = Xt(), qf = vs(), Wo = Oe(), Yo = jt(), Lf = Zt(), Df = Re(), Mf = pt(), Bf = us(), zo = Ht(), Vo = Ae(), Uf = at();
        function k(...t) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
      ...
      var Ho = y((Kv, jo) => {
        var { Container: Ff } = er(), Es = class extends Ff {
          constructor(e) {
      ...
      var Jo = y((Qv, Qo) => {
        ...
        Qo.exports = function(e, s = {}) {
          let r = e.css.valueOf(), n = s.ignoreErrors, i, o, a, u, c, f, p, l, w, x = r.length, h = 0, d = [], m = [], b;
          function g() {
            return h;
          }
          function v(T) {
          ...
          function F() {
            let T = 1, O = false, C = false;
            for (; T > 0; ) o += 1, r.length <= o && v("interpolation"), i = r.charCodeAt(o), l = r.charCodeAt(o + 1), O ? !C && i === O ? (O = false, C = false) : i === 92 ? C = !C : C && (C = false) : i === 39 || i === 34 ? O = i : i === 125 ? T -= 1 : i === 35 && l === 123 && (T += 1);
          }
          function H(T) {
            if (m.length) return m.pop();
            if (h >= x) return;
            let O = T ? T.ignoreUnclosed : false;
            switch (i = r.charCodeAt(h), i) {
              ...
              case 40: {
                ...
                } else o = r.indexOf(")", h + 1), u = r.slice(h, o + 1), o === -1 || $f.test(u) ? w = ["(", "(", h] : (w = ["brackets", u, h, o], h = o);
                break;
              }
              case 39:
              case 34: {
                for (a = i, o = h, f = false; o < x && (o++, o === x && v("string"), i = r.charCodeAt(o), l = r.charCodeAt(o + 1), !(!f && i === a)); ) i === 92 ? f = !f : f ? f = false : i === 35 && l === 123 && F();
                w = ["string", r.slice(h, o + 1), h, o], h = o;
                break;
              }
              case 64: {
                tr.lastIndex = h + 1, tr.test(r), tr.lastIndex === 0 ? o = r.length - 1 : o = tr.lastIndex - 2, w = ["at-word", r.slice(h, o + 1), h, o], h = o;
                break;
              }
              case 92: {
      ...
      var Zo = y((Jv, Xo) => {
        var { Comment: Wf } = er(), Yf = Kt(), zf = Ho(), Vf = Jo(), Ss = class extends Yf {
          atrule(e) {
            let s = e[1], r = e;
            for (; !this.tokenizer.endOfFile(); ) {
...
`)) break;
      ...
      var ta = y((Xv, ea) => {
        var { Input: Gf } = er(), jf = Zo();
        ea.exports = function(e, s) {
          let r = new Gf(e, s), n = new jf(r);
      ...
      var aa = y((vt) => {
        ...
        var Xf = Os(), na = ia(Xf), Zf = As(), Ns = ia(Zf);
        function ia(t) {
          return t && t.__esModule ? t : { default: t };
        }
        function oa(t) {
        ...
        function Ps(t) {
          ...
          for (var a = 0; a < t.length; a++) {
            var u = t[a];
            n ? (i.value += u, (u === "{" || u === "(") && r++, (u === ")" || u === "}") && r--) : u.search(/\s/) !== -1 ? i.before += u : (u === "(" && (i.type = "media-feature-expression", r++), i.value = u, i.sourceIndex = e + a, n = true), n && r === 0 && (u === ")" || a === t.length - 1 || t[a + 1].search(/\s/) !== -1) && (["not", "only", "and"].indexOf(i.value) !== -1 && (i.type = "keyword"), i.type === "media-feature-expression" && (i.nodes = oa(i.value, i.sourceIndex)), s.push(Array.isArray(i.nodes) ? new Ns.default(i) : new na.default(i)), i = o(), n = false);
          }
        ...
        function ep(t) {
          ...
          if (n !== null) {
            ...
            e.unshift(new na.default({ type: "url", value: t.substring(0, i).trim(), sourceIndex: n[1].length, before: n[1], after: /^(\s*)/.exec(t.substring(i))[1] })), s = i;
          }
          for (var u = s; u < t.length; u++) {
            var c = t[u];
            if (c === "(" && r++, c === ")" && r--, r === 0 && c === ",") {
              var f = t.substring(s, u), p = /^(\s*)/.exec(f)[1];
              e.push(new Ns.default({ type: "media-query", value: f.trim(), sourceIndex: s + p.length, nodes: Ps(f, s), before: p, after: /(\s*)$/.exec(f)[1] })), s = u + 1;
            }
          }
          var l = t.substring(s), w = /^(\s*)/.exec(l)[1];
          return e.push(new Ns.default({ type: "media-query", value: l.trim(), sourceIndex: s + w.length, nodes: Ps(l, s), before: w, after: /(\s*)$/.exec(l)[1] })), e;
        }
      });
      var ua = y((Rs) => {
        "use strict";
        ...
        Rs.default = ip;
        var tp = As(), rp = np(tp), sp = aa();
        function np(t) {
          return t && t.__esModule ? t : { default: t };
        }
        function ip(t) {
          return new rp.default({ nodes: (0, sp.parseMediaList)(t), type: "media-query-list", value: t.trim() });
        }
      });
      var qs = y((ax, fa) => {
      ...
      var Xa = y((kr, Ja) => {
        ...
        kr.__esModule = true;
        kr.default = Pd;
        var za = 39, bd = 34, Ms = 92, Va = 47, xt = 10, Bs = 32, Us = 12, Fs = 9, $s = 13, Ga = 43, ja = 62, Ha = 126, Ka = 124, _d = 44, kd = 40, Ed = 41, Sd = 91, Td = 93, Od = 59, Qa = 42, Cd = 58, Ad = 38, Nd = 64, br = /[ \n\t\r\{\(\)'"\\;/]/g, _r = /[ \n\t\r\(\)\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g;
        function Pd(t) {
          for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, a = void 0, u = void 0, c = void 0, f = void 0, p = void 0, l = void 0, w = void 0, x = s.length, h = -1, d = 1, m = 0, b = function(v, R) {
            ...
            switch (r = s.charCodeAt(m), r === xt && (h = m, d += 1), r) {
              ...
              case Us:
                n = m;
                do
                  n += 1, r = s.charCodeAt(n), r === xt && (h = n, d += 1);
              ...
              case bd:
                i = r === za ? "'" : '"', n = m;
                do
                  for (l = false, n = s.indexOf(i, n + 1), n === -1 && b("quote", i), w = n; s.charCodeAt(w - 1) === Ms; ) w -= 1, l = !l;
                while (l);
                e.push(["string", s.slice(m, n + 1), d, m - h, d, n - h, m]), m = n;
                break;
              case Nd:
                br.lastIndex = m + 1, br.test(s), br.lastIndex === 0 ? n = s.length - 1 : n = br.lastIndex - 2, e.push(["at-word", s.slice(m, n + 1), d, m - h, d, n - h, m]), m = n;
                break;
              case Ms:
                for (n = m, c = true; s.charCodeAt(n + 1) === Ms; ) n += 1, c = !c;
                r = s.charCodeAt(n + 1), c && r !== Va && r !== Bs && r !== xt && r !== Fs && r !== $s && r !== Us && (n += 1), e.push(["word", s.slice(m, n + 1), d, m - h, d, n - h, m]), m = n;
                break;
              default:
                r === Va && s.charCodeAt(m + 1) === Qa ? (n = s.indexOf("*/", m + 2) + 1, n === 0 && b("comment", "*/"), u = s.slice(m, n + 1), o = u.split(`
`), a = o.length - 1, a > 0 ? (f = d + a, p = n - o[a].length) : (f = d, p = h), e.push(["comment", u, d, m - h, f, n - p, m]), h = p, d = f, m = n) : (_r.lastIndex = m + 1, _r.test(s), _r.lastIndex === 0 ? n = s.length - 1 : n = _r.lastIndex - 2, e.push(["word", s.slice(m, n + 1), d, m - h, d, n - h, m]), m = n);
                break;
            }
            m++;
          }
      ...
      var tu = y((Er, eu) => {
        ...
        }(), Id = qs(), qd = I(Id), Ld = Ls(), Ws = I(Ld), Dd = Ds(), Md = I(Dd), Bd = ga(), Ud = I(Bd), Fd = xa(), Ys = I(Fd), $d = ka(), Wd = I($d), Yd = Sa(), zd = I(Yd), Vd = Oa(), Gd = I(Vd), jd = Aa(), Hd = I(jd), Kd = Pa(), Qd = I(Kd), Jd = Ia(), Xd = I(Jd), Zd = La(), em = I(Zd), tm = Ma(), rm = I(tm), sm = Ua(), nm = I(sm), im = $a(), om = I(im), am = Ya(), um = I(am), lm = Xa(), Za = I(lm), cm = D(), fm = pm(cm);
        function pm(t) {
          if (t && t.__esModule) return t;
          var e = {};
          if (t != null) for (var s in t) Object.prototype.hasOwnProperty.call(t, s) && (e[s] = t[s]);
        ...
        var dm = function() {
          function t(e) {
            hm(this, t), this.input = e, this.lossy = e.options.lossless === false, this.position = 0, this.root = new Ud.default();
            var s = new Ys.default();
            return this.root.append(s), this.current = s, this.lossy ? this.tokens = (0, Za.default)({ safe: e.safe, css: e.css.trim() }) : this.tokens = (0, Za.default)(e), this.loop();
          }
          return t.prototype.attribute = function() {
            ...
            if (o.length > 1 ? (o[0] === "" && (o[0] = true), a.attribute = this.parseValue(o[2]), a.namespace = this.parseNamespace(o[0])) : a.attribute = this.parseValue(i[0]), r = new em.default(a), i[2]) {
            ...
            this.newNode(new om.default({ value: this.currToken[1], source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] })), this.position++;
          }, t.prototype.parentheses = function() {
            var s = this.current.last;
            if (s && s.type === fm.PSEUDO) {
              var r = new Ys.default(), n = this.current;
            ...
            if (this.currToken[0] === "word") {
              ...
              this.splitWord(false, function(o, a) {
                r += o, i = new Xd.default({ value: r, source: { start: { line: n[2], column: n[3] }, end: { line: s.currToken[4], column: s.currToken[5] } }, sourceIndex: n[4] }), s.newNode(i), a > 1 && s.nextToken && s.nextToken[0] === "(" && s.error("Misplaced parenthesis.");
              });
            ...
            var s = this.currToken;
            this.newNode(new Qd.default({ value: this.currToken[1], source: { start: { line: s[2], column: s[3] }, end: { line: s[4], column: s[5] } }, sourceIndex: s[6] })), this.position++;
          }, t.prototype.universal = function(s) {
            var r = this.nextToken;
            if (r && r[1] === "|") return this.position++, this.namespace();
            this.newNode(new rm.default({ value: this.currToken[1], source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] }), s), this.position++;
            ...
            var c = (0, Ws.default)(o, "."), f = (0, Ws.default)(o, "#"), p = (0, Ws.default)(o, "#{");
            p.length && (f = f.filter(function(w) {
              return !~p.indexOf(w);
            }));
            var l = (0, um.default)((0, Md.default)((0, qd.default)([[0], c, f])));
            l.forEach(function(w, x) {
              var h = l[x + 1] || o.length, d = o.slice(w, h);
              if (x === 0 && r) return r.call(n, d, l.length);
              var m = void 0;
              ~c.indexOf(w) ? m = new Wd.default({ value: d.slice(1), source: { start: { line: n.currToken[2], column: n.currToken[3] + w }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }) : ~f.indexOf(w) ? m = new Gd.default({ value: d.slice(1), source: { start: { line: n.currToken[2], column: n.currToken[3] + w }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }) : m = new Hd.default({ value: d, source: { start: { line: n.currToken[2], column: n.currToken[3] + w }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }), n.newNode(m, s);
            }), this.position++;
          ...
          }, Rd(t, [{ key: "currToken", get: function() {
      ...
      var su = y((Sr, ru) => {
        ...
        var xm = function() {
          function t(e) {
            return vm(this, t), this.func = e || function() {
            }, this;
          }
          return t.prototype.process = function(s) {
            var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = new wm.default({ css: s, error: function(o) {
              throw new Error(o);
            }, options: r });
            return this.res = n, this.func(n), this;
          }, mm(t, [{ key: "result", get: function() {
      ...
      var z = y((Tx, iu) => {
        ...
        var zs = function(t, e) {
          ...
          for (let r in t) {
            ...
            let n = t[r], i = typeof n;
            r === "parent" && i === "object" ? e && (s[r] = e) : r === "source" ? s[r] = n : n instanceof Array ? s[r] = n.map((o) => zs(o, s)) : r !== "before" && r !== "after" && r !== "between" && r !== "semicolon" && (i === "object" && n !== null && (n = zs(n)), s[r] = n);
          }
          return s;
        };
        iu.exports = class {
...
` ? (r = 1, n += 1) : r += 1;
      ...
      var U = y((Ox, ou) => {
        ...
        Le.registerWalker = (t) => {
          let e = "walk" + t.name;
          e.lastIndexOf("s") !== e.length - 1 && (e += "s"), !Le.prototype[e] && (Le.prototype[e] = function(s) {
      ...
      var mu = y((Ix, du) => {
        "use strict";
        var Sm = U(), Tm = z(), Or = class extends Tm {
          constructor(e) {
      ...
      var wu = y((qx, yu) => {
        "use strict";
        var Om = U(), Cm = z(), Cr = class extends Cm {
          constructor(e) {
      ...
      var vu = y((Lx, gu) => {
        "use strict";
        var Am = U(), Nm = z(), Ar = class extends Nm {
          constructor(e) {
      ...
      var Eu = y((Mx, ku) => {
        "use strict";
        var Pm = U(), Rm = z(), Pr = class extends Rm {
          constructor(e) {
      ...
      var Tu = y((Bx, Su) => {
        "use strict";
        var Im = U(), qm = z(), Rr = class extends qm {
          constructor(e) {
      ...
      var Cu = y((Ux, Ou) => {
        "use strict";
        var Lm = U(), Dm = z(), Ir = class extends Dm {
          constructor(e) {
      ...
      var Nu = y((Fx, Au) => {
        "use strict";
        var Mm = U(), Bm = z(), qr = class extends Bm {
          constructor(e) {
      ...
      var Ru = y(($x, Pu) => {
        "use strict";
        var Um = U(), Fm = z(), Lr = class extends Fm {
          constructor(e) {
      ...
      var qu = y((Wx, Iu) => {
        "use strict";
        var $m = U(), Wm = z(), Dr = class extends Wm {
          constructor(e) {
      ...
      var Uu = y((zx, Bu) => {
        ...
        Bu.exports = function(e, s) {
          s = s || {};
          let r = [], n = e.valueOf(), i = n.length, o = -1, a = 1, u = 0, c = 0, f = null, p, l, w, x, h, d, m, b, g, v, R, F;
          function H(T) {
          ...
          for (; u < i; ) {
            switch (p = n.charCodeAt(u), p === 10 && (o = u, a += 1), p) {
              ...
              case 34:
                w = p === 39 ? "'" : '"', l = u;
                do
                  for (v = false, l = n.indexOf(w, l + 1), l === -1 && H("quote", w), R = l; n.charCodeAt(R - 1) === 92; ) R -= 1, v = !v;
                while (v);
                r.push(["string", n.slice(u, l + 1), a, u - o, a, l - o, u]), u = l;
                break;
              case 64:
                Mr.lastIndex = u + 1, Mr.test(n), Mr.lastIndex === 0 ? l = n.length - 1 : l = Mr.lastIndex - 2, r.push(["atword", n.slice(u, l + 1), a, u - o, a, l - o, u]), u = l;
                break;
              case 92:
...
`), h = x.length - 1, h > 0 ? (b = a + h, g = l - x[h].length) : (b = a, g = o), r.push(["comment", d, a, u - o, b, l - g, u]), o = g, a = b, u = l;
                } else if (p === 35 && !zm.test(n.slice(u + 1, u + 2))) l = u + 1, r.push(["#", n.slice(u, l), a, u - o, a, l - o, u]), u = l - 1;
      ...
      var Vu = y((jx, zu) => {
        ...
        zu.exports = class {
          constructor(e, s) {
            let r = { loose: false };
            this.cache = [], this.input = e, this.options = Object.assign({}, r, s), this.position = 0, this.unbalanced = 0, this.root = new Gm();
            let n = new jm();
          ...
          colon() {
            ...
            this.newNode(new Km({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++;
          }
          comma() {
            let e = this.currToken;
            this.newNode(new Qm({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++;
          }
          comment() {
            let e = false, s = this.currToken[1].replace(/\/\*|\*\//g, ""), r;
            this.options.loose && s.startsWith("//") && (s = s.substring(2), e = true), r = new Jm({ value: s, inline: e, source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[4], column: this.currToken[5] } }, sourceIndex: this.currToken[6] }), this.newNode(r), this.position++;
          }
          error(e, s) {
          ...
          operator() {
            ...
            return s = new ey({ value: this.currToken[1], source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] }), this.position++, this.newNode(s);
          }
          parseTokens() {
            switch (this.currToken[0]) {
              case "space":
          ...
          parenOpen() {
            ...
            if (e && this.error("Expected closing parenthesis", r), n = this.current.last, n && n.type === "func" && n.unbalanced < 0 && (n.unbalanced = 0, this.current = n), this.current.unbalanced++, this.newNode(new Wu({ value: r[1], source: { start: { line: r[2], column: r[3] }, end: { line: r[4], column: r[5] } }, sourceIndex: r[6] })), this.position++, this.current.type === "func" && this.current.unbalanced && this.current.value === "url" && this.currToken[0] !== "string" && this.currToken[0] !== ")" && !this.options.loose) {
              ...
              this.position !== this.tokens.length - 1 && (this.position++, this.newNode(new Yu({ value: o, source: { start: a, end: { line: this.currToken[4], column: this.currToken[5] } }, sourceIndex: this.currToken[6] })));
            }
          }
          parenClose() {
            let e = this.currToken;
            this.newNode(new Wu({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++, !(this.position >= this.tokens.length - 1 && !this.current.unbalanced) && (this.current.unbalanced--, this.current.unbalanced < 0 && this.error("Expected opening parenthesis", e), !this.current.unbalanced && this.cache.length && (this.current = this.cache.pop()));
          }
          space() {
            let e = this.currToken;
          ...
          splitWord() {
            ...
            i = iy(s, "@"), o = uy(oy(ny([[0], i]))), o.forEach((a, u) => {
              ...
              if (~i.indexOf(a)) p = new Hm({ value: f.slice(1), source: { start: { line: this.currToken[2], column: this.currToken[3] + a }, end: { line: this.currToken[4], column: this.currToken[3] + (c - 1) } }, sourceIndex: this.currToken[6] + o[u] });
              else if (r.test(this.currToken[1])) {
                let l = f.replace(r, "");
                p = new Zm({ value: f.replace(l, ""), source: { start: { line: this.currToken[2], column: this.currToken[3] + a }, end: { line: this.currToken[4], column: this.currToken[3] + (c - 1) } }, sourceIndex: this.currToken[6] + o[u], unit: l });
              } else p = new (e && e[0] === "(" ? Xm : Yu)({ value: f, source: { start: { line: this.currToken[2], column: this.currToken[3] + a }, end: { line: this.currToken[4], column: this.currToken[3] + (c - 1) } }, sourceIndex: this.currToken[6] + o[u] }), p.type === "word" ? (p.isHex = /^#(.+)/.test(f), p.isColor = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(f)) : this.cache.push(this.current);
              this.newNode(p);
            }), this.position++;
          }
          string() {
            let e = this.currToken, s = this.currToken[1], r = /^(\"|\')/, n = r.test(s), i = "", o;
            n && (i = s.match(r)[0], s = s.slice(1, s.length - 1)), o = new ty({ value: s, source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6], quoted: n }), o.raws.quote = i, this.newNode(o), this.position++;
          }
          word() {
      ...
      var Sy = {};
      Js(Sy, { languages: () => pi, options: () => di, parsers: () => Ks, printers: () => Ey });
      var hl = (t, e, s, r) => {
        if (!(t && e == null)) return e.replaceAll ? e.replaceAll(s, r) : s.global ? e.replace(s, r) : e.split(s).join(r);
      }, _ = hl;
      var Me = "string", Be = "array", Ue = "cursor", we = "indent", ge = "align", Fe = "trim", ve = "group", xe = "fill", oe = "if-break", $e = "indent-if-break", We = "line-suffix", Ye = "line-suffix-boundary", K = "line", ze = "label", be = "break-parent", _t = /* @__PURE__ */ new Set([Ue, we, ge, Fe, ve, xe, oe, $e, We, Ye, K, ze, be]);
      function dl(t) {
...
Expected it to be ${r}.`;
      ...
      function L(t, e = {}) {
        return ae(t), kt(e.expandedStates, true), { type: ve, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates };
      }
      function tn(t) {
      ...
      var je = { type: be };
      var wl = { type: K, hard: true };
      var A = { type: K }, M = { type: K, soft: true }, E = [wl, je];
      function V(t, e) {
        ae(t), kt(e);
        let s = [];
      ...
      var St = "'", sn = '"';
      function _l(t, e) {
        let s = e === true || e === St ? St : sn, r = s === St ? sn : St, n = 0, i = 0;
        for (let o of t) o === s ? n++ : o === r && i++;
        return n > i ? r : s;
      }
      var nn = _l;
      function kl(t, e, s) {
        let r = e === '"' ? "'" : '"', i = _(false, t, /\\(.)|(["'])/gsu, (o, a, u) => a === r ? a : u === e ? "\\" + u : u || (s && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(a) ? a : "\\" + a));
        return e + i + e;
      }
      var on = kl;
      function El(t, e) {
        let s = t.slice(1, -1), r = e.parser === "json" || e.parser === "jsonc" || e.parser === "json5" && e.quoteProps === "preserve" && !e.singleQuote ? '"' : e.__isInHtmlAttribute ? "'" : nn(s, e.singleQuote);
        return on(s, r, !(e.parser === "css" || e.parser === "less" || e.parser === "scss" || e.__embeddedInHtml));
      }
      var Tt = El;
      ...
      var _e = Sl;
      var Tl = /* @__PURE__ */ new Set(["raw", "raws", "sourceIndex", "source", "before", "after", "trailingComma", "spaces"]);
      function un(t, e, s) {
        if (_e(t) && t.language === "yaml" && delete e.value, t.type === "css-comment" && s.type === "css-root" && s.nodes.length > 0 && ((s.nodes[0] === t || _e(s.nodes[0]) && s.nodes[1] === t) && (delete e.text, /^\*\s*@(?:format|prettier)\s*$/u.test(t.text)) || s.type === "css-root" && G(false, s.nodes, -1) === t)) return null;
        if (t.type === "value-root" && delete e.text, (t.type === "media-query" || t.type === "media-query-list" || t.type === "media-feature-expression") && delete e.value, t.type === "css-rule" && delete e.params, (t.type === "media-feature" || t.type === "media-keyword" || t.type === "media-type" || t.type === "media-unknown" || t.type === "media-url" || t.type === "media-value" || t.type === "selector-attribute" || t.type === "selector-string" || t.type === "selector-class" || t.type === "selector-combinator" || t.type === "value-string") && t.value && (e.value = Ol(t.value)), t.type === "selector-combinator" && (e.value = _(false, e.value, /\s+/gu, " ")), t.type === "media-feature" && (e.value = _(false, e.value, " ", "")), (t.type === "value-word" && (t.isColor && t.isHex || ["initial", "inherit", "unset", "revert"].includes(t.value.toLowerCase())) || t.type === "media-feature" || t.type === "selector-root-invalid" || t.type === "selector-pseudo") && (e.value = e.value.toLowerCase()), t.type === "css-decl" && (e.prop = t.prop.toLowerCase()), (t.type === "css-atrule" || t.type === "css-import") && (e.name = t.name.toLowerCase()), t.type === "value-number" && (e.unit = t.unit.toLowerCase()), t.type === "value-unknown" && (e.value = _(false, e.value, /;$/gu, "")), t.type === "selector-attribute" && (e.attribute = t.attribute.trim(), t.namespace && typeof t.namespace == "string" && (e.namespace = t.namespace.trim() || true), t.value && (e.value = _(false, e.value.trim(), /^["']|["']$/gu, ""), delete e.quoted)), (t.type === "media-value" || t.type === "media-type" || t.type === "value-number" || t.type === "selector-root-invalid" || t.type === "selector-class" || t.type === "selector-combinator" || t.type === "selector-tag") && t.value && (e.value = _(false, e.value, /([\d+.e-]+)([a-z]*)/giu, (r, n, i) => {
          let o = Number(n);
      ...
      function Ol(t) {
        return _(false, _(false, t, "'", '"'), /\\([^\da-f])/giu, "$1");
      }
      var ln = un;
      async function Cl(t, e) {
        if (t.language === "yaml") {
          let s = t.value.trim(), r = s ? await e(s, { parser: "yaml" }) : "";
          return tn([t.startDelimiter, t.explicitLanguage, E, r, r ? E : "", t.endDelimiter]);
        }
      }
      var cn = Cl;
      function fn(t) {
      ...
      function Ke(t) {
        ...
        return He = Ke.prototype = t ?? /* @__PURE__ */ Object.create(null), new Ke();
      }
      var Al = 10;
...
`, s) + 1;
      ...
      var Tw = Ot(/\s/u), Ct = Ot(" 	"), yn = Ot(",; 	"), At = Ot(/[^\n\r]/u);
      function wn(t, e) {
        var s, r, n;
      ...
      function Vr(t, e) {
        ...
        if (t.source) {
          ...
          if (ee(t.nodes)) return Vr(G(false, t.nodes, -1), e);
        }
        return null;
      }
      function Gr(t, e) {
...
` || a === "\r") && (n && i.push([r, o]), e = "initial", n = false);
        ...
        for (let [o, a] of i) t = t.slice(0, o) + _(false, t.slice(o, a), /["'*]/gu, " ") + t.slice(a);
        return t;
      }
      function N(t) {
        var e;
      ...
      function On(t) {
        let e = `
`;
        t = _(false, t.replace(Dl, "").replace(Ll, ""), Ul, "$1");
        let s = "";
        for (; s !== t; ) s = t, t = _(false, t, Bl, `${e}$1 $2${e}`);
        t = t.replace(xn, "").trimEnd();
        let r = /* @__PURE__ */ Object.create(null), n = _(false, t, bn, "").replace(xn, "").trimEnd(), i;
        for (; i = bn.exec(t); ) {
          let o = _(false, i[2], Ml, "");
...
`);
      ...
      function Nn(t) {
        ...
        let s = Sn(t), { pragmas: r, comments: n } = On(s);
      ...
      function Rn(t) {
        let { shebang: e, text: s, pragmas: r, comments: n } = Nn(t), i = Tn(s), o = Cn({ pragmas: { format: "", ...r }, comments: n.trimStart() });
        return (e ? `${e}
` : "") + o + (i.startsWith(`
`) ? `
` : `
...
...`, s)), n === -1) return;
        ...
        let u = t.slice(0, o);
        return { type: "front-matter", language: i, explicitLanguage: r, value: t.slice(s + 1, n), startDelimiter: e, endDelimiter: u.slice(-Qe), raw: u };
      }
      function Wl(t) {
        let e = $l(t);
        if (!e) return { content: t };
        let { raw: s } = e;
        return { frontMatter: e, content: _(false, s, /[^\n]/gu, " ") + t.slice(s.length) };
      }
      var Je = Wl;
      function In(t) {
...
` : "") + Rn(s);
      ...
      var Yl = /* @__PURE__ */ new Set(["red", "green", "blue", "alpha", "a", "rgb", "hue", "h", "saturation", "s", "lightness", "l", "whiteness", "w", "blackness", "b", "tint", "shade", "blend", "blenda", "contrast", "hsl", "hsla", "hwb", "hwba"]);
      function Ln(t) {
        var e, s;
        return (s = (e = t.findAncestor((r) => r.type === "css-decl")) == null ? void 0 : e.prop) == null ? void 0 : s.toLowerCase();
      }
      var zl = /* @__PURE__ */ new Set(["initial", "inherit", "unset", "revert"]);
      function Dn(t) {
      ...
      function jr(t) {
        var e;
        return t.type === "value-paren_group" && ((e = t.groups) == null ? void 0 : e[0]) && It(t.groups[0]);
      }
      function Kr(t, e) {
        var i;
      ...
      function ei(t) {
        return t.type !== "value-func" ? false : Yl.has(t.value.toLowerCase());
      }
      function Se(t) {
      ...
      function Gl(t, e, s) {
        var d;
        let { node: r } = t, n = t.parent, i = t.grandparent, o = Ln(t), a = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), u = t.findAncestor((m) => m.type === "css-atrule"), c = u && Ze(u, e), f = r.groups.some((m) => Qr(m)), p = t.map(s, "groups"), l = [], w = ke(t, "url"), x = false, h = false;
        for (let m = 0; m < r.groups.length; ++m) {
          l.push(p[m]);
          let b = r.groups[m - 1], g = r.groups[m], v = r.groups[m + 1], R = r.groups[m + 2];
          if (w) {
            (v && Q(v) || Q(g)) && l.push(" ");
            continue;
          }
          if (Ee(t, "forward") && g.type === "value-word" && g.value && b !== void 0 && b.type === "value-word" && b.value === "as" && v.type === "value-operator" && v.value === "*" || !v || g.type === "value-word" && g.value.endsWith("-") && tt(v)) continue;
          if (g.type === "value-string" && g.quoted) {
            let C = g.value.lastIndexOf("#{"), me = g.value.lastIndexOf("}");
            C !== -1 && me !== -1 ? x = C > me : C !== -1 ? x = true : me !== -1 && (x = false);
          }
          if (x || Dt(g) || Dt(v) || g.type === "value-atword" && (g.value === "" || g.value.endsWith("[")) || v.type === "value-word" && v.value.startsWith("]") || g.value === "~" || g.type !== "value-string" && g.value && g.value.includes("\\") && v && v.type !== "value-comment" || b != null && b.value && b.value.indexOf("\\") === b.value.length - 1 && g.type === "value-operator" && g.value === "/" || g.value === "\\" || Kn(g, v) || qt(g) || Jr(g) || Lt(v) || Jr(v) && ce(v) || Lt(g) && ce(v) || g.value === "--" && qt(v)) continue;
          let F = Pt(g), H = Pt(v);
          if ((F && qt(v) || H && Lt(g)) && ce(v) || !b && Xe(g) || ke(t, "calc") && (Q(g) || Q(v) || le(g) || le(v)) && ce(v)) continue;
          let $ = (Q(g) || le(g)) && m === 0 && (v.type === "value-number" || v.isHex) && i && ei(i) && !ce(v), T = (R == null ? void 0 : R.type) === "value-func" || R && et(R) || g.type === "value-func" || et(g), O = v.type === "value-func" || et(v) || (b == null ? void 0 : b.type) === "value-func" || b && et(b);
          if (e.parser === "scss" && F && g.value === "-" && v.type === "value-func" && P(g) !== N(v)) {
            l.push(" ");
            continue;
          }
          if (!(!(Nt(v) || Nt(g)) && !ke(t, "calc") && !$ && (Xe(v) && !T || Xe(g) && !O || Q(v) && !T || Q(g) && !O || le(v) || le(g)) && (ce(v) || F && (!b || b && Pt(b)))) && !((e.parser === "scss" || e.parser === "less") && F && g.value === "-" && rt(v) && P(g) === N(v.open) && v.open.value === "(")) {
            if (Qr(g)) {
            ...
            if (a) {
              g.source && v.source && g.source.start.line !== v.source.start.line ? (l.push(E), h = true) : l.push(" ");
              continue;
            }
            if (H) {
              l.push(" ");
            ...
            if ((v == null ? void 0 : v.value) !== "..." && !(tt(g) && tt(v) && P(g) === N(v))) {
              ...
              (d = g.value) != null && d.endsWith("#") && v.value === "{" && rt(v.group) || l.push(A);
            }
          }
        }
        return f && l.push(je), h && l.unshift(E), c ? L(q(l)) : Un(t) ? L(Ge(l)) : L(q(Ge(l)));
      }
      var ri = Gl;
      function jl(t) {
      ...
      var ii = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu, Hl = /(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu, Kl = /[a-z]+/giu, Ql = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu, Jl = new RegExp(ii.source + `|(${Ql.source})?(${Hl.source})(${Kl.source})?`, "giu");
      function W(t, e) {
        return _(false, t, ii, (s) => Tt(s, e));
      }
      function oi(t, e) {
        let s = e.singleQuote ? "'" : '"';
      ...
      function fe(t) {
        return _(false, t, Jl, (e, s, r, n, i) => !r && n ? Zr(n) + te(i || "") : e);
      }
      function Zr(t) {
...
` || n === "\r" || n === "\u2028" || n === "\u2029") return e + 1;
      ...
      var Mt = Xl;
      function Zl(t, e, s = {}) {
        let r = Ct(t, s.backwards ? e - 1 : e, s), n = Mt(t, r, s);
        return r !== n;
      }
      var Bt = Zl;
      function ec(t, e) {
      ...
      function rc(t, e) {
        ...
        return r = li(t, r), r = Mt(t, r), r !== false && Bt(t, r);
      }
      var Ut = rc;
      ...
      function nc(t, e) {
        return $n(t.grandparent) && sc(t, e) ? "," : t.node.type !== "value-comment" && !(t.node.type === "value-comma_group" && t.node.groups.every((s) => s.type === "value-comment")) && ai(e) && t.callParent(() => Kr(t, e)) ? Et(",") : "";
      }
      function ci(t, e, s) {
        ...
        if (!r.open) {
          let w = es(t), x = V([",", w ? E : A], i);
          return q(w ? [E, x] : L(Ge(x)));
        }
        let o = t.map(({ node: w, isLast: x, index: h }) => {
          var b;
          let d = i[h];
          if (It(w) && w.type === "value-comma_group" && w.groups && w.groups[0].type !== "value-paren_group" && ((b = w.groups[2]) == null ? void 0 : b.type) === "value-paren_group") {
          ...
          return m;
        }, "groups"), a = Xn(r, n), u = ti(r, n), c = Kr(t, e), f = u || c && !a, p = u || a, l = L([r.open ? s("open") : "", q([M, V(A, o)]), M, r.close ? s("close") : ""], { shouldBreak: f });
        return p ? ue(l) : l;
      }
      function es(t) {
      ...
      function ic(t, e, s) {
        ...
        return t.each(() => {
          ...
          let { next: o } = t;
          o.type === "css-comment" && !Bt(e.originalText, N(o), { backwards: true }) && !_e(n) || o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment" ? r.push(" ") : (r.push(e.__isHTMLStyleAttribute ? A : E), Ut(e.originalText, P(n)) && !_e(n) && r.push(E));
        }, "nodes"), r;
      }
      var Te = ic;
      function oc(t, e, s) {
        ...
        switch (r.type) {
          ...
          case "css-rule":
            return [s("selector"), r.important ? " !important" : "", r.nodes ? [((n = r.selector) == null ? void 0 : n.type) === "selector-unknown" && Se(r.selector.value) ? A : r.selector ? " " : "", "{", r.nodes.length > 0 ? q([E, Te(t, e, s)]) : "", E, "}", Wn(r) ? ";" : ""] : ";"];
          case "css-decl": {
            ...
            return h = Qn(r) ? rn(h) : h, !w && Se(l) && !((o = (i = r.value) == null ? void 0 : i.group) != null && o.group && t.call(() => es(t), "value", "group", "group")) && (h = q([E, ue(h)])), [_(false, r.raws.before, /[\s;]/gu, ""), f.type === "css-atrule" && f.variable || Bn(t) ? r.prop : te(r.prop), l.startsWith("//") ? " " : "", l, r.extend || x ? "" : " ", e.parser === "less" && r.extend && r.selector ? ["extend(", s("selector"), ")"] : "", h, r.raws.important ? r.raws.important.replace(/\s*!\s*important/iu, " !important") : r.important ? " !important" : "", r.raws.scssDefault ? r.raws.scssDefault.replace(/\s*!default/iu, " !default") : r.scssDefault ? " !default" : "", r.raws.scssGlobal ? r.raws.scssGlobal.replace(/\s*!global/iu, " !global") : r.scssGlobal ? " !global" : "", r.nodes ? [" {", q([M, Te(t, e, s)]), M, "}"] : Hn(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";" ? "" : e.__isHTMLStyleAttribute && t.isLast ? Et(";") : ";"];
          }
          case "css-atrule": {
          ...
          case "media-feature":
            return te(W(_(false, r.value, / +/gu, " "), e));
          case "media-colon":
            return [r.value, " "];
          case "media-value":
            return fe(W(r.value, e));
          case "media-keyword":
            return W(r.value, e);
          case "media-url":
            return W(_(false, _(false, r.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), e);
          case "media-unknown":
            return r.value;
          case "selector-root":
          ...
          case "selector-string":
            return W(r.value, e);
          case "selector-tag":
            return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", ((u = t.previous) == null ? void 0 : u.type) === "selector-nesting" ? r.value : fe(Mn(t, r.value) ? r.value.toLowerCase() : r.value)];
          case "selector-id":
            return ["#", r.value];
          case "selector-class":
            return [".", fe(W(r.value, e))];
          case "selector-attribute":
            return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), r.operator ?? "", r.value ? oi(W(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
          ...
          case "value-operator":
            return r.value;
          case "value-word":
            return r.isColor && r.isHex || Dn(r.value) ? r.value.toLowerCase() : r.value;
          case "value-colon": {
            let { previous: f } = t;
      ...
      var ac = { print: oc, embed: pn, insertPragma: qn, massageAstNode: ln, getVisitorKeys: mn }, fi = ac;
      ...
      var hi = { bracketSpacing: { category: "Common", type: "boolean", default: true, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." }, singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] }, bracketSameLine: { category: "Common", type: "boolean", default: false, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: false, description: "Enforce single attribute per line in HTML, Vue and JSX." } };
      var uc = { singleQuote: hi.singleQuote }, di = uc;
      var Ks = {};
      ...
      function cy(t) {
        return Br(t).text.slice(t.group.open.sourceIndex + 1, t.group.close.sourceIndex).trim();
      }
      var Gu = cy;
      function fy(t) {
        if (ee(t)) {
      ...
      function dy(t, e) {
        ...
        for (let c = 0; c < s.length; ++c) {
          let f = s[c];
          if (e.parser === "scss" && f.type === "number" && f.unit === ".." && f.value.endsWith(".") && (f.value = f.value.slice(0, -1), f.unit = "..."), f.type === "func" && f.value === "selector" && (f.group.groups = [Z(Br(t).text.slice(f.group.open.sourceIndex + 1, f.group.close.sourceIndex))]), f.type === "func" && f.value === "url") {
      ...
      function Ur(t) {
        return t.type === "paren_group" && !t.open && !t.close && t.groups.length === 1 || t.type === "comma_group" && t.groups.length === 1 ? Ur(t.groups[0]) : t.type === "paren_group" || t.type === "comma_group" ? { ...t, groups: t.groups.map(Ur) } : t;
      }
      function Ju(t, e) {
        if (t && typeof t == "object") for (let s in t) s !== "parent" && (Ju(t[s], e), s === "nodes" && (t.group = Ur(dy(t, e)), delete t[s]));
        return t;
      }
      function my(t, e) {
        ...
        let s = null;
        try {
          s = new Qu.default(t, { loose: true }).parse();
        } catch {
      ...
      var ie = my;
      var yy = /* @__PURE__ */ new Set(["import", "use", "forward"]);
      function wy(t) {
        return yy.has(t);
      }
      var Xu = wy;
        ...
        if (t && typeof t == "object") {
          ...
          if (t.raws ?? (t.raws = {}), t.type === "css-decl" && typeof t.prop == "string" && t.prop.startsWith("--") && typeof t.value == "string" && t.value.startsWith("{")) {
            ...
            if (t.value.trimEnd().endsWith("}")) {
              let u = e.originalText.slice(0, t.source.start.offset), c = "a".repeat(t.prop.length) + e.originalText.slice(t.source.start.offset + t.prop.length, t.source.end.offset), f = _(false, u, /[^\n]/gu, " ") + c, p;
          ...
          let o = "";
          if (typeof t.params == "string" && (o = t.raws.params ? t.raws.params.scss ?? t.raws.params.raw : t.params, t.raws.afterName && t.raws.afterName.trim().length > 0 && (o = t.raws.afterName + o), t.raws.between && t.raws.between.trim().length > 0 && (o = o + t.raws.between), o = o.trim(), t.raws.params = o), n.trim().length > 0) return n.startsWith("@") && n.endsWith(":") ? t : t.mixin ? (t.selector = ie(n, e), t) : (Zu(t, e) && (t.isSCSSNesterProperty = true), t.selector = Z(n), t);
          if (i.length > 0) {
            let a = i.match(vy);
          ...
          if (t.type === "css-atrule" && o.length > 0) {
            ...
            return a === "warn" || a === "error" ? (t.params = { type: "media-unknown", value: o }, t) : a === "extend" || a === "nest" ? (t.selector = Z(o), delete t.params, t) : a === "at-root" ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(o) ? t.params = ie(o, e) : (t.selector = Z(o), delete t.params), t) : Xu(u) ? (t.import = true, delete t.filename, t.params = ie(o, e), t) : ["namespace", "supports", "if", "else", "for", "each", "while", "debug", "mixin", "include", "function", "return", "define-mixin", "add-mixin"].includes(a) ? (o = o.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2"), o = o.replace(/^(?!if)(\S+)(\s+)\(/u, "$1($2"), t.value = ie(o, e), delete t.params, t) : ["media", "custom-media"].includes(u) ? o.includes("#{") ? { type: "media-unknown", value: o } : (t.params = ca(o), t) : (t.params = o, t);
          }
        }
        return t;
      }
      function js(t, e, s) {
        ...
        try {
          ...
          throw typeof c != "number" ? o : ra(`${a}: ${u}`, { loc: { start: { line: c, column: f } }, cause: o });
        }
        return s.originalText = e, i = sl(J(i, "css-"), s), Gr(i, e), n && (n.source = { startOffset: 0, endOffset: n.raw.length }, i.frontMatter = n), i;
      }
      function nl(t, e = {}) {
      ...
      var Hs = { astFormat: "postcss", hasPragma: In, locStart: N, locEnd: P }, by = { ...Hs, parse: nl }, _y = { ...Hs, parse: il }, ky = { ...Hs, parse: ol };
      var Ey = { postcss: fi };
      return pl(Sy);
    });
  }
...
//# sourceMappingURL=prettier_parser-postcss.js.map
